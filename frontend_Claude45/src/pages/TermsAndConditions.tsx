        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              We pursue flight compensation claims as assignee of your rights under the submitted claim(s).
              We do not guarantee any specific outcome or compensation amount, as final decisions are made by airlines.
            </p>
          </section>

          {/* Service Agreement and Assignment of Claims */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">3. Service Agreement and Assignment of Claims</h2>

            <h3 className="text-xl font-semibold mb-3">3.1 Assignment of Claims</h3>
            <p className="mb-4">
              By submitting a claim through our Service, you irrevocably assign, transfer, and convey to
              ClaimPlane LLC all your rights, title, and interest in and to the specific flight compensation
              claim(s) submitted (the "Assigned Claim"), including:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>All rights to compensation under EU Regulation 261/2004 and/or other applicable air passenger rights regulations</li>
              <li>All related causes of action, demands, and entitlements against the airline and/or relevant authorities</li>
              <li>The right to receive any compensation payments, interest, or other amounts payable in respect of the Assigned Claim</li>
              <li>All associated remedies, documentation rights, and procedural entitlements</li>
            </ul>
            <p className="mb-4">
              This assignment is absolute for the Assigned Claim, made for value (our services), and allows
              ClaimPlane LLC to pursue, negotiate, settle (subject to limits below), enforce, and receive
              payment in its own name.
            </p>
            <p className="mb-4">
              Upon assignment you grant ClaimPlane LLC the following specific authorities in relation to the Assigned Claim:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>To represent and act in connection with the Assigned Claim before airlines, aviation authorities, dispute resolution bodies, and other third parties</li>
              <li>To submit, file, prosecute, and manage the Assigned Claim</li>
              <li>To negotiate settlement terms with airlines (settlements below the statutory compensation amount require your final approval)</li>
              <li>To access and obtain all information from airlines and authorities related to your flight and the Assigned Claim</li>
              <li>To sign documents, submit forms, and execute agreements necessary for pursuing the Assigned Claim</li>
            </ul>
            <p className="mb-4">
              <strong>Important Notes:</strong>
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li>The assignment is limited in scope to the specific claim(s) you submit through our Service</li>
              <li>The assignment remains effective for the duration of processing the Assigned Claim, including any appeals or dispute resolution proceedings</li>
              <li>You may terminate the assignment (and withdraw the Assigned Claim) at any time by following the termination procedure in Section 3.5</li>
              <li>Confirmation of the assignment will be stored securely in your account and available for download through the customer portal</li>
              <li>The assignment does not transfer rights unrelated to your flight compensation claim</li>
            </ul>
            <p className="mb-4">
              In certain cases, if required by an airline, aviation authority, court, dispute resolution body,
              or applicable law for procedural, enforcement, or payment purposes, you agree to execute and
              provide a separate limited Power of Attorney (PoA) in favor of ClaimPlane LLC solely to
              facilitate handling of the Assigned Claim. Such PoA would be narrow in scope, aligned with
              the assignment, and provided digitally for electronic signature via email or the customer portal.
              Refusal to sign a reasonably requested PoA in such circumstances may hinder or prevent successful
              resolution of the claim, and we will notify you promptly if this becomes necessary.
            </p>
            ...
            <p className="mb-4">ClaimPlane LLC commits to:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
              ...
              <li>Act in good faith and with reasonable care in pursuing the Assigned Claim</li>
            ...
            <p className="mb-4">
              Once you submit a claim through our Service (effecting the assignment), you grant us exclusive
              rights to pursue that specific Assigned Claim for a period of 90 days from submission. You may
              not withdraw the claim or pursue it through other channels during this period without our written consent.
            </p>

            <h3 className="text-xl font-semibold mb-3">3.5 Termination of Claim or Agreement</h3>
            <p className="mb-4">
              You have the right to terminate this agreement and revoke/withdraw the assignment of your claim
              at any time by sending a written notice to support@claimplane.com. To ensure proper processing,
            ...
            <div className="bg-muted p-6 rounded-lg mb-4 font-mono text-sm">
              ...
              <p className="mb-2">I hereby formally request the termination of my claim agreement and withdrawal/revocation of the assignment of my claim with the following details:</p>
              ...
              <p className="mb-1 ml-4">This termination will take effect within 5 business days of receipt</p>
              <p className="mb-1 ml-4">If compensation has already been received, applicable fees will still apply</p>
              <p className="mb-4 ml-4">I may pursue this claim independently or through other services after termination</p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">When an airline pays compensation:</p>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">Our Service is provided "as is" and "as available." We do not guarantee that:</p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <p className="mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, CLAIMPLANE LLC SHALL NOT BE LIABLE FOR:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-2">
